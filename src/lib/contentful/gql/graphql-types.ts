...
export type ComponentTextLinkingCollectionsPageCollectionArgs = {
  limit?: InputMaybe<Scalars['Int']['input']>;
  locale?: InputMaybe<Scalars['String']['input']>;
  order?: InputMaybe<Array<InputMaybe<ComponentTextLinkingCollectionsPageCollectionOrder>>>;
  preview?: InputMaybe<Scalars['Boolean']['input']>;
  skip?: InputMaybe<Scalars['Int']['input']>;
};

export enum ComponentTextLinkingCollectionsPageCollectionOrder {
  NameAsc = 'name_ASC',
  NameDesc = 'name_DESC',
  SlugAsc = 'slug_ASC',
  SlugDesc = 'slug_DESC',
...
/** [See type definition](https://app.contentful.com/spaces/8h4rcnu50txt/content_types/page) */
export type PageChildPagesCollectionArgs = {
  limit?: InputMaybe<Scalars['Int']['input']>;
  locale?: InputMaybe<Scalars['String']['input']>;
  order?: InputMaybe<Array<InputMaybe<PageChildPagesCollectionOrder>>>;
  preview?: InputMaybe<Scalars['Boolean']['input']>;
  skip?: InputMaybe<Scalars['Int']['input']>;
...
/** [See type definition](https://app.contentful.com/spaces/8h4rcnu50txt/content_types/page) */
export type PageContentAreaCollectionArgs = {
  limit?: InputMaybe<Scalars['Int']['input']>;
  locale?: InputMaybe<Scalars['String']['input']>;
  order?: InputMaybe<Array<InputMaybe<PageContentAreaCollectionOrder>>>;
  preview?: InputMaybe<Scalars['Boolean']['input']>;
  skip?: InputMaybe<Scalars['Int']['input']>;
...
export type PageChildPagesCollection = {
  __typename?: 'PageChildPagesCollection';
...
export enum PageChildPagesCollectionOrder {
  NameAsc = 'name_ASC',
  NameDesc = 'name_DESC',
  SlugAsc = 'slug_ASC',
  SlugDesc = 'slug_DESC',
...
export type PageContentAreaCollection = {
  __typename?: 'PageContentAreaCollection';
  items: Array<Maybe<ComponentText>>;
  limit: Scalars['Int']['output'];
  skip: Scalars['Int']['output'];
  total: Scalars['Int']['output'];
...
export enum PageContentAreaCollectionOrder {
  SysFirstPublishedAtAsc = 'sys_firstPublishedAt_ASC',
  SysFirstPublishedAtDesc = 'sys_firstPublishedAt_DESC',
  SysIdAsc = 'sys_id_ASC',
  SysIdDesc = 'sys_id_DESC',
...
export type PageFilter = {
  ...
  childPages?: InputMaybe<CfPageNestedFilter>;
  childPagesCollection_exists?: InputMaybe<Scalars['Boolean']['input']>;
  contentArea?: InputMaybe<CfComponentTextNestedFilter>;
  contentAreaCollection_exists?: InputMaybe<Scalars['Boolean']['input']>;
  contentfulMetadata?: InputMaybe<ContentfulMetadataFilter>;
...
export type CfComponentTextNestedFilter = {
  AND?: InputMaybe<Array<InputMaybe<CfComponentTextNestedFilter>>>;
  OR?: InputMaybe<Array<InputMaybe<CfComponentTextNestedFilter>>>;
  contentfulMetadata?: InputMaybe<ContentfulMetadataFilter>;
  sys?: InputMaybe<SysFilter>;
  text_contains?: InputMaybe<Scalars['String']['input']>;
  text_exists?: InputMaybe<Scalars['Boolean']['input']>;
